...
//we will use this schema to add product in our database.
app.post('/addproduct',async(req,res)=>{
    let products=await Product.find({});
    let id;
    if(products.length>0){
        let last_product_array=products.slice(-1);  //in the array we will get only the last product
     ...
     console.log(product);
     await product.save();  //any product created will be saved automatically in mongodb database.
     console.log("Saved");
     res.json({
        success:true,
        name:req.body.name,
